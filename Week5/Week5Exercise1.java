...
class Main {
  public static void main(String[] args) {
    ...
    m.printArray(newArray);
    ArrayList<Integer> newArrayList = m.convertIntArrayToArrayList(exampleArray);
    m.printArrayList(newArrayList);

  }

  // * - method to convert an array of ints to an array of doubles 
  public double[] convertIntArray(int[] array){
    double[] intToDoubleArray = new double[array.length];
    for(int i=0; i<array.length; i++){
      intToDoubleArray[i] = (double)array[i];
    }
